...
cmds.add_argument('-w', dest='outputfile', metavar=default_xml_filename, nargs='?', const=default_xml_filename, help=u'epg.xml')
...
opts.add_argument('-i', dest='ips', help=u'sk', default='ALL')
